<template>
    <div class="modal fade" ref="modal" id="edit-project" tabindex="-1" role="dialog" aria-labelledby="edit-project-label" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" @submit.prevent="onSubmit">
                <div class="modal-header">
                    <h5 class="modal-title" id="edit-project-label">Edit Project</h5>
...
<script>
    export default {
            ...
            onSubmit() {
                ...
                (async () => {
                    try {
                        ...
                        await axios.put(this.$root.route('api.projects.update', this.id), data);
                        this.isSubmitting = false;
        ...
        created() {
            ...
            this.$root.$on('project-edit', this.onEdit);
        },
        beforeDestroyed() {
