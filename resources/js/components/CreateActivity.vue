<template>
    <div class="modal fade" ref="modal" id="create-activity" tabindex="-1" role="dialog" aria-labelledby="create-activity-label" aria-hidden="true">
        <div class="modal-dialog">
            <form class="modal-content" @submit.prevent="onSubmit">
                <div class="modal-header">
                    <h5 class="modal-title" id="create-activity-label">New Activity</h5>
            ...
            onSubmit() {
                ...
                (async () => {
                    try {
                        ...
                        await axios.post(this.$root.route('api.activities.store'), data);
                        this.isSubmitting = false;
