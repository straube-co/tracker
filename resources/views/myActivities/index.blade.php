                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('my.update', $time->id )}}" method="post">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="project">Project: </label>
                                                <select class="custom-select @if ($errors->has('project_id')) is-invalid @endif" name="project_id" id="project">
                                                    <option value="">Select</option>
                                                    @foreach ($projects as $project)
                                            ...
                                            <div class="form-group">
                                                <label for="task">Task: </label>
                                                <select class="custom-select @if ($errors->has('task_id')) is-invalid @endif" name="task_id" id="task">
                                                    <option value="">Select</option>
                                                    @foreach ($tasks as $task)
                                            ...
                                            <div class="form-group">
                                                <label for="activity">Activity: </label>
                                                <select class="custom-select @if ($errors->has('activity_id')) is-invalid @endif" name="activity_id" id="activity">
                                                    <option value="">Select</option>
                                                    @foreach ($activities as $activity)
                                        ...
                                        <div class="modal-footer justify-content-start">
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Cancel</button>
                                            <button class="btn btn-danger btn-sm ml-auto" type="button" onclick="$('#form_delete-{{ $time->id }}').submit()">Delete </button>
                                        </div>
                                    </form>
                                    <form action="{{ route('my.destroy', $time->id) }}" method="post" id="form_delete-{{ $time->id }}">
                                        {{ csrf_field() }}
                                        {{ method_field('delete') }}
                                    </form>
                                </div>
